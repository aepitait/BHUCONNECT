...
public class Complain extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ImageView personImage = (ImageView)rootView.findViewById(R.id.personType);
            EditText EmailORId =(EditText)rootView.findViewById(R.id.uniqueIdOrEmail);
            EditText uniqueId = (EditText)rootView.findViewById(R.id.uniqueId);

            // condition for switching to student login in TabWidget for registering complain
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1){
                personImage.setImageResource(R.drawable.student);
                EmailORId.setHint(R.string.roll_number);
                uniqueId.setHint(R.string.enrollment_number);
                //button onClickListner will check if the email is vaild and direct to complain page
                Button loginButtonStudent = (Button)rootView.findViewById(R.id.login_button);
                loginButtonStudent.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity( new Intent(getActivity(), WriteComplain.class) );
                    }
                });
            ...
            //condition for switching to employee login in Tabwidget for registering complain
                ...
                EmailORId.setHint(R.string.emailId);
                uniqueId.setHint(R.string.empId);
                //button onClickListner will check if the email is vaild and direct to complain page
                Button loginButtonStudent = (Button)rootView.findViewById(R.id.login_button);
                loginButtonStudent.setOnClickListener(new View.OnClickListener() {
                    @Override
